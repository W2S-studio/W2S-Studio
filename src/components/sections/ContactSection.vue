  ...
  <section id="contact" class="py-32 bg-white relative">
    <div class="max-w-7xl mx-auto px-6">
      <div class="section-reveal text-center">
        <h2 class="text-5xl md:text-7xl font-black mb-8 leading-tight" data-aos="fade-down" data-aos-duration="800"
          data-aos-delay="0">
          {{ t('contact.title1') }}<br />
          <span class="text-gradient">{{ t('contact.title2') }}</span><br />
          {{ t('contact.title3') }}
        </h2>
        <p class="text-xl text-gray-600 mb-12 max-w-2xl mx-auto" data-aos="fade-down" data-aos-duration="700"
          data-aos-delay="200">
          {{ t('contact.description') }}
        </p>

        <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto mb-8" data-aos="fade-down"
